...
public class Adaptador extends RecyclerView.Adapter<Adaptador.ViewHolderMusica> implements View.OnClickListener,View.OnCreateContextMenuListener {
    ...
    public void onBindViewHolder(ViewHolderMusica holder, int position) {
        holder.botoncomprar.setBackgroundColor(listaMusica.get(position).getColor());
        ...
        holder.informacionmusica.setText(listaMusica.get(position).getCancion());
    ...
    public class ViewHolderMusica extends RecyclerView.ViewHolder {
        ...
        TextView nombremusica,informacionmusica;
        ImageView imagen;
        CardView card;
        Button botoncomprar;
        public ViewHolderMusica(View itemView) {
            ...
            botoncomprar=(Button) itemView.findViewById(R.id.btncomprar);
            nombremusica= (TextView) itemView.findViewById(R.id.tipomusica);
            informacionmusica= (TextView) itemView.findViewById(R.id.detalles);
